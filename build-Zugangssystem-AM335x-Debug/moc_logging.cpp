...
QT_MOC_LITERAL(5, 45, 14), // "GetCurrentTime"
QT_MOC_LITERAL(6, 60, 10), // "logMessage"
QT_MOC_LITERAL(7, 71, 5), // "index"
QT_MOC_LITERAL(8, 77, 12), // "copyLogfiles"
...
static const uint qt_meta_data_Logging[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       ...
       6,    1,   79,    2, 0x2a /* Public | MethodCloned */,
...
void Logging::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->GetCurrentTime(); break;
        case 3: _t->logMessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 4: _t->logMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Logging::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Logging::GetCurrentTime)) {
                *result = 2;
                return;
            }
        }
